...
namespace SAEON.Identity.Service.UI
{
    public class AccountController : Controller
    {
        ...
        private async Task<(SAEONUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<SAEONUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
