    ...
    public class Startup
    {
        ...
        private async Task InitializeDbAsync(IApplicationBuilder app)
        {
            using (var scope = app.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
            {
                ...
                string[] roles = new string[] { "SAEON.Admin", "Observations.Reader", "Observations.Writer", "Observations.Admin", "Observations.QuerySite", };
                foreach (var role in roles)
                {
                ...
                await AddUserAsync("Administrator", "SAEON", "admin@saeon.ac.za", "0d3DHCClCsAh", new string[] { "SAEON.Admin", "Observations.Admin", "Observations.Reader", "Observations.Writer" }, userManager);
                await AddUserAsync("Tim", "Parker-Nance", "timpn@saeon.ac.za", "T1mS@E0N", new string[] { "SAEON.Admin", "Observations.Admin", "Observations.Reader", "Observations.Writer" }, userManager);
